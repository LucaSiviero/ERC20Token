...
NETWORK_ARGS := --rpc-url http://localhost:8545 --account $(ANVIL_ACCOUNT) --sender $(ANVIL_SENDER) --broadcast 
...
deploy:
	@forge script script/DeployBetterToken.s.sol:DeployBetterToken $(NETWORK_ARGS)
